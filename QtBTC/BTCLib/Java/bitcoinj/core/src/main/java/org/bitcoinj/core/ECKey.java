...
public class ECKey implements EncryptableItem {
    ...
    public static class ECDSASignature {
        ...
        public ECDSASignature toCanonicalised() {
            if (!isCanonical()) {
                ...
                System.out.println("!!!!!!!!!!!!!!!ECKey.isCanonical() = false!!!!!!!!!!!!!!!!!!!!");
        ...
        public static ECDSASignature decodeFromDER(byte[] bytes) throws SignatureDecodeException {
            ...
            try {
                ...
                System.out.println("ECDSASignature decodeFromDER(byte[] bytes) r:" + r);
                System.out.println("ECDSASignature decodeFromDER(byte[] bytes) s:" + s);
                System.out.println("ECDSASignature decodeFromDER(byte[] bytes) r+:" + r.getPositiveValue());
                System.out.println("ECDSASignature decodeFromDER(byte[] bytes) s+:" + s.getPositiveValue());
    ...
    protected ECDSASignature doSign(Sha256Hash input, BigInteger privateKeyForSigning) {
        ...
        System.out.println("Dosign input in Hex = " + Hex.toHexString(input.getBytes()));
        System.out.println("Dosign r = " + components[0]);
        System.out.println("Dosign s = " + components[1]);
